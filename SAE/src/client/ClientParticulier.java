 ...
 * Un client qui est un particulier a un nom de contact comme caractèristique supplémentaire.
 *
 * @version 05/04/22
...
public class ClientParticulier extends Client
{
	...
	/**
	 * Constructeur permettant d'initialiser un nouveau client de type particulier avec son nom, 
	 * son adresse, son prénom et son genre. Son numéro de référence est généré automatiquement.
	 * 
	...
	/**
	 * Constructeur permettant d'initialiser un nouveau client de type particulier en effectuant la saisie au clavier de son nom, 
	 * son adresse, son prénom et son genre (en utilisant la méthode saisirInfos()). Son numéro de référence est généré automatiquement.
	 */
	...
	{
		super.saisirInfos();
		this.prenom = Util.saisirChaine("Veullier entrez le prenom du client : ");
		if (Util.questionBinaire("Veullier entrez le genre du client (H/F) ", "H", "F"))
