 ...
 */
public class ArticleCat3 extends Article implements Livrable
{
    /**
     * Taille des roues
     */
    ...
    /**
     * Carburant utilisé par le tricycle hybride
     */
    private String carburant;

    /**
     * Taille de la batterie du tricycle
     */
     ...
     */
    public ArticleCat3(String categorie, String designation, double prix, int quantiteStock, int tailleRoues, String carburant, String materiaux, boolean eclairage, int poids, int largeur, int hauteur, int profondeur)
    {
