...
public interface Livrable {
	...
	/**
	 * Méthode retournant une chaîne de caractères représentant les informations sur l'article Livrable concernant les caractèristiques nécessaires son transport.
	 * 
	...
	/**
	 * Méthode retournant le coùt de livraison de l'article livrable :
	 * 1.5 euros par m3 du volume du colis + 1.1 euro par kg du colis.
	 * 
	 * @return Le coùt de livraison de l'article livrable.
	 */
	default public double coutLivraison()
	{
		double volumeM3 = (getHauteurColis() * getLargeurColis() * getProfondeurColis()) / 1_000_000.0;
